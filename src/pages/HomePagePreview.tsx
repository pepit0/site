...
/** Experimental homepage — edit freely; promote to HomePage.tsx or delete this route when done. */
  ...
  return (
    <div className="home home-preview">
      <Seo
        ...
        description="Internal preview of a new Temptation Motorsports homepage design."
        path={HOME_PREVIEW_PATH}
        noindex
      />
      ...
      <section ref={slideshowTopRef} className="home-previewTop" aria-label="Hero">
        ...
        <div className="home-content home-previewContent">
          <div className="home-previewLenders">
            <HomeLendersPanel />
          </div>

          <div className="home-previewContentInner">
            <section className="home-previewHero" aria-labelledby="home-preview-hook">
              <img
                src={logoUrl}
              ...
              <h1 id="home-preview-hook" className="home-previewHook">
      ...
      >
        <aside
          id="home-preview-categories-panel"
        ...
        <button
          ...
          aria-controls="home-preview-categories-panel"
