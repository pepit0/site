-- Add income_tenure to preapproval_leads + extend submit_public_preapproval_lead (28-arg).
-- Prerequisite: 12 or 13 applied. Run on marketing Supabase as postgres, then reload schema.
