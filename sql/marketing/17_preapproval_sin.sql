-- Add optional sin to preapproval_leads + extend submit_public_preapproval_lead (29-arg).
-- Prerequisite: 16 applied. Run on marketing Supabase as postgres, then reload schema.
