-- Extended pre-approval application fields (marketing Supabase). Run as postgres after 04 + 05.
-- Extends preapproval_leads + replaces submit_public_preapproval_lead; matches src/lib/submitPublicPreapprovalLead.ts.
-- monthly_budget_cad convention from UI: 199 = less than $200/mo, 200–1000 = stepped slider, 1001 = $1000+/mo.
...
-- Replace RPC (signature change): remove every overload so only the 27-arg version exists.
