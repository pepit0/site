-- Pre-approval: require consent to be contacted; credit pull consent is optional.
-- Run on marketing as postgres after 12/13. Re-run 13 if you prefer the full repair file instead of this patch.
